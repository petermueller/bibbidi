...
defmodule Bibbidi.Types.Script.ObjectRemoteValue do
  @moduledoc """
  ...
  - `value` - `t:Bibbidi.Types.Script.MappingRemoteValue.t/0` (optional)
  """
  ...
  @schema Zoi.map(%{
            ...
            value:
              Zoi.lazy({Bibbidi.Types.Script.MappingRemoteValue, :schema, []}) |> Zoi.optional()
          })
  @type t :: %{
          type: String.t(),
          handle: Bibbidi.Types.Script.Handle.t() | nil,
          internal_id: Bibbidi.Types.Script.InternalId.t() | nil,
          value: Bibbidi.Types.Script.MappingRemoteValue.t() | nil
        }
