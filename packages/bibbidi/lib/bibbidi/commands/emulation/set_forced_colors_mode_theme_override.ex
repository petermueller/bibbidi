...
defmodule Bibbidi.Commands.Emulation.SetForcedColorsModeThemeOverride do
  ...
  [WebDriver BiDi Spec](https://w3c.github.io/webdriver-bidi/#command-emulation-setForcedColorsModeThemeOverride)
  ## Fields

  - `theme` - `t:Bibbidi.Types.Emulation.ForcedColorsModeTheme.t/0` or `nil` (required)
  ...
  @schema Zoi.struct(__MODULE__, %{
            theme:
              Zoi.union([Bibbidi.Types.Emulation.ForcedColorsModeTheme.schema(), Zoi.null()]),
