  ...
  defp docs do
    [
      ...
      groups_for_modules: [
        ...
        Browser: ~r/Bibbidi\.(Commands|Types)\.Browser/,
        BrowsingContext: ~r/Bibbidi\.(Commands|Types|Events)\.BrowsingContext/,
        Emulation: ~r/Bibbidi\.(Commands|Types)\.Emulation/,
        Input: ~r/Bibbidi\.(Commands|Types|Events)\.Input/,
        Log: ~r/Bibbidi\.(Commands|Types|Events)\.Log/,
        Network: ~r/Bibbidi\.(Commands|Types|Events)\.Network/,
        Script: ~r/Bibbidi\.(Commands|Types|Events)\.Script/,
        Session: ~r/Bibbidi\.(Commands|Types)\.Session/,
        Storage: ~r/Bibbidi\.(Commands|Types)\.Storage/,
        WebExtension: ~r/Bibbidi\.(Commands|Types)\.WebExtension/,
      ...
      nest_modules_by_prefix: [
        ...
        Bibbidi.Types,
        Bibbidi.Types.Browser,
        Bibbidi.Types.BrowsingContext,
        Bibbidi.Types.Emulation,
        Bibbidi.Types.Input,
        Bibbidi.Types.Log,
        Bibbidi.Types.Network,
        Bibbidi.Types.Script,
        Bibbidi.Types.Session,
        Bibbidi.Types.Storage,
        Bibbidi.Types.WebExtension,
        Bibbidi.Events,
